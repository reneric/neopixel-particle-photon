...
// void Visualize() {
//   switch (visual) {
//     case 0: return PalettePulse();
//     case 1: return PalettePulse();
//     case 2: return PalettePulse();
//     case 3: return PalettePulse();
//     case 4: return PalettePulse();
//     case 5: return PalettePulse();
...
void Pulse() {
  ...
  if (volume > 0) {
    ...
    int start = LED_HALF - (LED_HALF * (volume / maxVol)) + bumpAddition;
    int finish = LED_HALF + (LED_HALF * (volume / maxVol)) + strand.numPixels() % 2 + bumpAddition;
